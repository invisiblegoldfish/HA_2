...
write_rds(recent_tracks_par, paste0("saved_data/my_recent_tracks_", Sys.Date(), ".rds"))
write_rds(top_tracks_par, paste0("saved_data/my_top_tracks_", Sys.Date(), ".rds"))
write_rds(top_artists_par, paste0("saved_data/my_top_artists_", Sys.Date(), ".rds"))
